...
> Ce gestionnaire de téléchargement ne sert pas à programmer l’ESP8266 (voir [*Compilation et téléchargement*](#compilation-et-telechargement) pour cette fonctionnalité), mais à télécharger des fichiers annexes, typiquement des fichiers qui seront servis par une interface web ou des fichiers de configuration.
...
La compilation et téléchargement se font exactement comme pour une carte Arduino. Il peut y avoir quelques différences de fonctionnalité liées aux différences du hardware. Il y a [quelques informations sur le GitHub d’ESP8266](https://github.com/esp8266/Arduino/blob/master/doc/libraries.md) et Adafruit a aussi documenté quelques différences sur [leur *fork*](https://github.com/adafruit/ESP8266-Arduino).
