...
La carte est donc une *LoLin* du fabriquant [WeMos](http://www.wemos.cc/){:target="_blank"}
...
- [eLua project](http://www.eluaproject.net){:target="_blank"}
- <http://blog.nyl.io/esp8266-motor/>{:target="_blank"}
