...
⚠ Cette carte utilise une puce CH340G pour la communication USB. Pour l’installation du pilote sur OSX, voir l’article [_Utiliser un chip CH340G au lieu d’un FTDI_](/ch340_driver/).
...
> Note : Adafruit et LoLin proposent d’autres gestionnaires. J’ai choisi la version de la communauté qui maintient le site [esp8266.com](http://www.esp8266.com). [La version d’Adafruit](https://github.com/adafruit/ESP8266-Arduino) est un _fork_ de celle d’_esp8266.com_.
...
La compilation et le téléchargement se font exactement comme pour une carte Arduino. Pour la programmation, il peut y avoir quelques différences de fonctionnalité liées aux différences du hardware et à l’implémentation des bibliothèques. Il y a [quelques informations sur le GitHub d’ESP8266](https://github.com/esp8266/Arduino/blob/master/doc/libraries.md) et Adafruit a aussi documenté quelques différences sur [leur _fork_](https://github.com/adafruit/ESP8266-Arduino).
