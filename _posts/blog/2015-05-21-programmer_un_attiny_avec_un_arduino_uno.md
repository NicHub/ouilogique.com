...
Le but de ce document est de présenter la programmation d’un microcontrôleur ATtiny25V à l’aide d’un Arduino UNO. Ce mode de programmation s’appelle en anglais _AVR ISP (in-system programmer)_. L’IDE Arduino utilisé pendant les tests était la version 1.5.8 bêta Java 6.
