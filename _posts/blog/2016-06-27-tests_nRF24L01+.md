...
| `IRQ`  | output    | *Maskable interrupt pin*<br/>Ce signal est actif à 0 et controlé par trois sources d’interruption masquables               |
...
La bibliothèque *Radiohead* de Mike McCauley permet de communiquer via une quantité impressionante de protocoles différents, y compris le nRF24.
